...
const accepted = { id: "fact-1", entityId: "entity-student-1", kind: "academic", predicate: "掌握", value: "已掌握有理数加法", subjectRef: "数学", topicRef: "有理数", confidence: { basis: "explicit", score: 1 }, status: "accepted", sourceIds: ["session-1", "material-source-2"], observationIds: ["observation-1"], conflictIds: [], hasPredecessor: false, revision: 1 };
...
test("student details show Core fact status and the original source text", () => {
  const html = renderToStaticMarkup(React.createElement(EduPiStudentFacts, { factSpine, studentId: "roster-student-1", reviewer: "teacher", onEducation() {} }));
  assert.match(html, /学习事实/);
