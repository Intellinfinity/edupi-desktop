...
type Props = {
  ...
  onUpload: () => void;
  onIntakeMaterial: (item: MaterialStagingDescriptor, metadata: MaterialIntakeMetadata, calendarSourceId: string | null, calendarSourceFingerprint: string | null) => Promise<unknown>;
