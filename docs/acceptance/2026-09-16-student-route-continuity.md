...
- 代码版本：Desktop `d472ccb1fcc55161f88dabf1f8efc552681af111`，PR [#157](https://github.com/PIGU-PPPgu/edupi-desktop/pull/157)。
...
| 只带 `module=students` 与稳定 `student` ID、不带 `view` | 兼容旧深链并打开同一学生 | 通过；解析后的目标视图为学生档案，URL 无需补写 `view` |
