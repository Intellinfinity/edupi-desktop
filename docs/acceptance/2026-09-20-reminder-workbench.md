...
- 已安装 v0.3.40 在教师设置点击“测试通知跳转”，页面回读“系统已接受通知；点击通知应打开提醒”，系统通知状态为“已开启”。macOS 系统设置中 EduPi 通知为“标记、声音和桌面”，但全局“当镜像或共享屏幕时”为“关闭通知”；当前共享环境未出现可点击通知。此结果只验收请求被系统接受，不验收通知实际展示和点击路由。
