...
| Local release workflow check | `node --test scripts/release-workflows.test.mjs`, `actionlint .github/workflows/release.yml` | Paired conflict E2 and macOS packaged review/feedback become release gates | Passed locally. GitHub CI has not run on this Desktop head because push authentication is unavailable |
