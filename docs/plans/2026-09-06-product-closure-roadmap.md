...
## 2026-09-25 R18/R20/R21 AI 协作与提醒续聊复核（包内隔离验收，v0.3.41 发布准备）
...
- 该修正尚未进入公开 v0.3.40；v0.3.41 元数据和发布门禁已准备。macOS 安装版通知测试只确认系统接受，未观察到点击返回提醒；真实睡眠唤醒、正式模型内容和真实教师材料仍未因此验收，R21/L4 整体继续部分实现。
