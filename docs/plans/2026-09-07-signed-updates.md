...
- 隔离代理 CONNECT、失败缓存/重试、800×900 页面及 Rust/TypeScript 门禁已有证据，见 [更新代理验收](../acceptance/2026-09-24-update-proxy.md)。本机以 `127.0.0.1:7897` 为显式代理请求 GitHub API 返回 200；功能尚未进入签名包，真实应用内下载、验签、替换与重启仍未验。
