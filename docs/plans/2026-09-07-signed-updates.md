...
- 隔离代理 CONNECT、失败缓存/重试、800×900 页面及 Rust/TypeScript 门禁已有证据，见 [更新代理验收](../acceptance/2026-09-24-update-proxy.md)。当前 7897 系统规则存在但监听进程不在，真实 VPN 连接及签名安装版升级未验；不能宣称自动更新已在该端口端到端通过。
