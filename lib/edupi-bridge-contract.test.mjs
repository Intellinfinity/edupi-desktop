...
test("pins the v1.1 default and opt-in v1.2 occurrence identities", () => {
  ...
  assert.equal(manifest.core_runtime.core_commit, "86a49de9278704b3b64ad637c13acc03f21d34b5");
  assert.equal(manifest.core_runtime.component_manifest_hash, "sha256:d878f2fb5127f0874636975172ae0630b67b6b42957e7718b1983309e3e9632f");
  assert.equal(manifest.core_runtime.runtime_component_manifest_hash, "sha256:e2790002f558026ddf316ba259ffb3626468e63469a4ec05023c75dc67a56452");
