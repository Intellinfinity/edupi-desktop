...
test("pins the v1.1 default and opt-in v1.2 occurrence identities", () => {
  ...
  assert.equal(manifest.core_runtime.core_commit, "c1edefd2a2b77e3d10dfc9f0a47eceb7b5f7b1de");
  ...
  assert.equal(manifest.core_runtime.runtime_component_manifest_hash, "sha256:c3dc57b89820cc1ebaa671554e1c5be452e8da19fd02639bbc23aac1e1555b79");
