...
test("pins the v1.1 default and opt-in v1.2 occurrence identities", () => {
  ...
  assert.equal(manifest.core_runtime.core_commit, "a8fe4711419fe3f36a19fd342e17abe33a7825b9");
  assert.equal(manifest.core_runtime.component_manifest_hash, "sha256:8092bd3d10af41683433e87e6a06d0da4d9fdc2e83a631eb1b9e59c267486bf7");
  assert.equal(manifest.core_runtime.runtime_component_manifest_hash, "sha256:844eebaf4339062f0189df2af66762152780db043c8ea0b6baefa45fb118c851");
  assert.equal(manifest.core_runtime.runtime_schema_hash, "sha256:9c8c287a8d8eeaea2905fb83b64742a5841e664d766cfa58b0791bf17caf88dc");
