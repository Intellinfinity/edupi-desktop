...
test("pins the v1.1 default and opt-in v1.2 occurrence identities", () => {
  ...
  assert.equal(manifest.core_runtime.core_commit, "68004b2c0294159eef4f88bcbf4a921ef6978037");
  ...
  assert.equal(manifest.core_runtime.runtime_component_manifest_hash, "sha256:87d742475908524522328869f7c4d402e06b6fc61f4f196989d7b174a13b1183");
