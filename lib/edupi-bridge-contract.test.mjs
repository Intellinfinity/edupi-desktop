...
test("pins the Core v1.1 education projection runtime capability manifest", () => {
  ...
  assert.equal(manifest.core_runtime.core_commit, "75cba8d4a331722ea2b34fb78e4e1943d02b79fb");
  assert.equal(manifest.core_runtime.component_manifest_hash, "sha256:44d84b04262cd198db92f60edc18e31214f5918af0f580e0db11cea1329c0bfb");
  assert.equal(manifest.core_runtime.runtime_component_manifest_hash, "sha256:b9ccf03ef155cbdf35c39bdfd6500829ddb72abc285be19c5cb260b1bbfcef42");
