...
test("pins the v1.1 default and opt-in v1.2 occurrence identities", () => {
  ...
  assert.equal(manifest.core_runtime.core_commit, "860594a05c5d32617fffdbdf03d56e6ade6dc211");
  ...
  assert.equal(manifest.core_runtime.runtime_component_manifest_hash, "sha256:f98d0de51c19773c760a9cc208029eac091d7f31b37a7665bfe953d23813a4ca");
