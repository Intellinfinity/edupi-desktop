...
const projection = {
  ...
  attention_deliveries: [{
    ...
    work_case_id: "work_case_attention",
    deep_link: "edupi://today/work/work_case_attention",
    carrier: { kind: "desktop", instance_id: "desktop-test" },
    delivery_id: "reminder-1",
    version: 2,
    status: "opened",
    failure_code: null,
    occurred_at: "2026-09-19T01:00:02.000Z",
    created_at: "2026-09-19T01:00:00.000Z",
    updated_at: "2026-09-19T01:00:02.000Z",
    intent_current: true,
    teacher_acceptance: "not_recorded",
    external_send: false,
  }],
  external_send: false,
};
...
test("normalizes the Core l4 projection without weakening its safety boundary", () => {
  ...
  assert.equal(normalized.attentionDeliveries[0].status, "opened");
...
test("projects l4 preparation into the Desktop education contract", () => {
  ...
  assert.equal(contract.l4Preparation.attentionDeliveries[0].carrier.kind, "desktop");
});
