import type { EducationContract, EducationTeacherMaterial, TeacherTask } from "./edupi-education-contract";
...
export type MaterialRow = { id: string; title: string; category: Exclude<MaterialCategoryId, "all">; type: string; subject: string; source: string; date: string | null; status: string; summary: string; task: TeacherTask | null; filePath: string | null; deleteKind: "task" | "material" | "generated" | null; material?: EducationTeacherMaterial };
