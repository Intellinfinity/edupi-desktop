...
test("formats only the schedule reported by the active Core Runtime", () => {
  ...
  assert.equal(formatCoreSchedulerStatus({ timer_active: true, timer_error_code: "source_unavailable", next_timer_check_at: null, interval_ms: 300000 }, 1), "自动检查失败 · source_unavailable");
});
