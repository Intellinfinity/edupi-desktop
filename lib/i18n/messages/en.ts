...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.phoneControl": "Phone control",
    "chat.moreStreamingActions": "More message actions",
    ...
    "appSettings.verifying": "Verifying signature…",
    ...
    "appSettings.downloadFailed": "The update download was interrupted. Check your connection and try again.",
    "appSettings.signatureFailed": "The update could not be verified. Try again later.",
    "appSettings.manifestFailed": "The update feed could not be checked. Try again later.",
    "appSettings.installFailed": "The update could not be installed. Your current version is still in place.",
    "appSettings.updateFailed": "The update did not finish. Try again later.",
    "appSettings.updateDiagnostics": "Show diagnostics",
    "appSettings.updateStage": "Stage",
    "appSettings.updateStage.manifest": "Manifest check",
    "appSettings.updateStage.download": "Asset download",
    "appSettings.updateStage.signature": "Signature verification",
    "appSettings.updateStage.install": "Install and restart",
    "appSettings.updateStage.unknown": "Update",
    "appSettings.updateHost": "Host",
    "appSettings.updateRetries": "Retries",
    "appSettings.updateErrorCode": "Error code",
