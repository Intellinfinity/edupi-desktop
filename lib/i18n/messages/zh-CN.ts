...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.addFile": "添加文件",
    "chat.phoneControl": "手机控制",
    "chat.moreStreamingActions": "更多消息动作",
    ...
    "appSettings.downloadFailed": "更新包下载中断，请检查网络后重试。",
    "appSettings.signatureFailed": "更新包验证失败，请稍后重试。",
    "appSettings.manifestFailed": "更新清单检查失败，请稍后重试。",
    "appSettings.installFailed": "更新安装失败，当前版本仍保留。",
    "appSettings.updateFailed": "更新未完成，请稍后重试。",
    "appSettings.updateDiagnostics": "查看诊断",
    "appSettings.updateStage": "阶段",
    "appSettings.updateStage.manifest": "清单检查",
    "appSettings.updateStage.download": "资产下载",
    "appSettings.updateStage.signature": "签名验证",
    "appSettings.updateStage.install": "安装与重启",
    "appSettings.updateStage.unknown": "更新",
    "appSettings.updateHost": "主机",
    "appSettings.updateRetries": "重试次数",
    "appSettings.updateErrorCode": "错误码",
